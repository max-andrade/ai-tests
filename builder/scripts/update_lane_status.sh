...
if [[ $# -ne 2 ]]; then
  echo "Usage: $0 <lane_id> <planned|in_progress|blocked|done|integrated>"
  exit 1
fi
...
const valid = new Set(["planned", "in_progress", "blocked", "done", "integrated"]);
